...
from cloth_app.api.views.admin_utility import AdminUtilityAPIList,AdminUtilityLoginAPIList,AdminUtilityOrderAPIList
...
urlpatterns = [
    ...
    path('admin_order_detail', AdminUtilityOrderAPIList.as_view() , name='admin_order_detail'),
